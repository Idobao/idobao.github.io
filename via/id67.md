...
<div class="border shadow shadow-sm border-warning bg-warning bg-opacity-10 rounded-3 p-2 mb-4 text-opacity-75">
  <ul class="fa-ul mb-0 me-3">
    ...
    For the ID67 <i>(with the "V2" firmware, featuring the richer QMK RGB Matrix library)</i>, you will need to sideload the <tt>json</tt> file below into VIA each time VIA is started.
...
| "V2" Firmware<br><small>*(with QMK RGB Matrix)*</small> | ID67 V2<br>ID67 Crystal<br>ID67 Bestype | [<i class="fas fa-rotate-90 fa-download"></i> `id67-v2.json`]({{ site.github_raw_path }}/via/id67-v2.json) | 
